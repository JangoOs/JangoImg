...
namespace ImageConsoleImage
{
    class Program
    {
        ...
        //    MediaTypeNames.Image imgPhoto = MediaTypeNames.Image.FromFile(WorkingDirectory + "\\watermark_photo.jpg");
        ...
        //    MediaTypeNames.Image imgWatermark = new Bitmap(WorkingDirectory + "\\watermark.bmp");
